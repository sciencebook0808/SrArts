...
// Use a distinct name — `FormData` is a reserved global Web API type
...
export default function CommissionPage() {
  ...
  const {
    ...
    reset,
  } = useForm<CommissionFormValues>({ resolver: zodResolver(schema) });
            ...
            {done ? (
              ...
              >
                ...
                <p className="text-muted-foreground max-w-sm mx-auto">
                  We've received your commission request and will contact you within 24 hours.
                </p>
                <button
              ...
              >
                ...
                <div className="bg-white border border-border rounded-2xl p-6 shadow-sm space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Portrait of my character Aira"
                      className={inp(!!errors.projectTitle)}
                    />
                  ...
                  <div>
                    ...
                    <select {...register('style')} className={inp(!!errors.style)}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select {...register('budget')} className={inp(!!errors.budget)}>
                    ...
                    <div>
                      ...
                      <select {...register('timeline')} className={inp(!!errors.timeline)}>
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-muted-foreground">
                    I agree to the commission terms — a 50% deposit is required to begin,
                    the remainder due on completion.
                    {errors.terms && (
                      <span className="block text-red-500 mt-1">{errors.terms.message}</span>
                    )}
                  </span>
                </label>

 ...
 *  - `afterSignUpUrl` REMOVED    → use `fallbackRedirectUrl`
 *  - Page is noindex
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f8f4f0] via-white to-[#f0f4f8] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500">Join the SR Arts community</p>
        </div>

...
import { getArtworks, getCategories } from '@/lib/appwrite-server';
      ...
      <section className="pt-28 md:pt-32 pb-12 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl">
            Explore original artwork across multiple styles — each piece crafted from imagination.
          </p>
        </div>
      </section>

      {/* Client-side filter grid */}
      <GalleryGrid artworks={artworks as unknown as Record<string, string>[]} categories={categories as unknown as {$id: string; name: string}[]} />

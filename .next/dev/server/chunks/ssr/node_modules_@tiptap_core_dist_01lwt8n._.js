...
var deleteSelection = ()=>({ state, dispatch })=>{
        ...
        if (dispatch) {
            ...
            if (!tr.selection.empty) {
                tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextSelection"].near(tr.doc.resolve(tr.selection.from)));
            }
            tr.scrollIntoView();
            dispatch(tr);
        }
...
var insertContentAt = (position, value, options)=>({ tr, dispatch, editor })=>{
        ...
        if (dispatch) {
            ...
            if (isOnlyTextContent) {
                ...
                newContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"].from(nodes);
...
var DECORATION_MANAGER_PLUGIN_KEY = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PluginKey"](DECORATION_MANAGER_PLUGIN_KEY_NAME);
...
var isDev = typeof process !== "undefined" && ("TURBOPACK compile-time value", "development") !== "production";
;
...
function buildDecorationSet(doc, decorations, extensionName) {
    ...
    return {
        set: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DecorationSet"].create(doc, pmDecorations),
        widgetKeys
    };
}
...
function mapDecorations(name, previous, tr) {
    var _a, _b;
    const previousSet = (_a = previous.decorationSetsByExtension[name]) != null ? _a : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DecorationSet"].empty;
...
function mergeDecorationSets(doc, decorationSetsByExtension) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DecorationSet"].create(doc, allDecorations);
}
   ...
   */ createPlugin() {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Plugin"]({
            ...
            props: {
                decorations (state) {
                    var _a, _b;
                    return (_b = (_a = DECORATION_MANAGER_PLUGIN_KEY.getState(state)) == null ? void 0 : _a.mergedDecorationSet) != null ? _b : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DecorationSet"].empty;
                }
            }
        });
    }
...
function warnOnDuplicatedProseMirrorModel(schema) {
    ...
    let content;
    try {
        content = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ReplaceStep"].fromJSON(schema, {
            from: 0,
            to: 0
        }).slice.content;
    } catch  {
    ...
    if (content instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"]) {
        return;
    }
...
var InlineDecoration = class extends Decoration {
    ...
    toPMDecoration(extensionName) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Decoration"].inline(this.from, this.to, this.attrs, spec);
    }
};
var NodeDecoration = class extends Decoration {
    ...
    toPMDecoration(extensionName) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Decoration"].node(this.from, this.to, this.attrs, spec);
    }
};
var WidgetDecoration = class extends Decoration {
    ...
    toPMDecoration(extensionName) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Decoration"].widget(this.pos, this.render, spec);
    }
};

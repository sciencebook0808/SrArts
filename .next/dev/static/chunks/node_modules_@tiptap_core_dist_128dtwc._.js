...
var deleteSelection = ()=>({ state, dispatch })=>{
        ...
        if (dispatch) {
            ...
            if (!tr.selection.empty) {
                tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"].near(tr.doc.resolve(tr.selection.from)));
            }
            tr.scrollIntoView();
            dispatch(tr);
        }
...
function isAndroid() {
    return [
        "Android"
    ].includes(navigator.platform) || /android/i.test(navigator.userAgent);
}
...
var insertContentAt = (position, value, options)=>({ tr, dispatch, editor })=>{
        ...
        if (dispatch) {
            ...
            if (isOnlyTextContent) {
                ...
                newContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(nodes);
...
var setContent = (content, { errorOnInvalidContent, emitUpdate = true, parseOptions = {} } = {})=>({ editor, tr, dispatch, commands })=>{
        ...
        if (parseOptions.preserveWhitespace !== "full") {
            ...
            if (dispatch) {
                const nodes = isFragment(document2) ? document2.content : [
                    document2
                ];
...
var DECORATION_MANAGER_PLUGIN_KEY = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluginKey"](DECORATION_MANAGER_PLUGIN_KEY_NAME);
// src/commands/updateDecorations.ts
var updateDecorations = (extensionName)=>({ tr, dispatch })=>{
        if (dispatch) {
            tr.setMeta(DECORATION_MANAGER_PLUGIN_KEY, {
                type: "force",
                name: extensionName
            });
        }
...
var isDev = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== "undefined" && ("TURBOPACK compile-time value", "development") !== "production";
;
...
function buildDecorationSet(doc, decorations, extensionName) {
    ...
    return {
        set: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].create(doc, pmDecorations),
        widgetKeys
    };
}
...
function mapDecorations(name, previous, tr) {
    var _a, _b;
    const previousSet = (_a = previous.decorationSetsByExtension[name]) != null ? _a : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].empty;
...
function mergeDecorationSets(doc, decorationSetsByExtension) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].create(doc, allDecorations);
}
    ...
    switch(strategy){
        case "document":
            if (spec.createInRange) {
                throw new Error(`[tiptap error]: Extension "${name}" provides createInRange() but does not use the "changedRanges" decoration update strategy.`);
            }
            return;
        case "changedRanges":
            if (!spec.createInRange) {
                throw new Error(`[tiptap error]: Extension "${name}" uses the "changedRanges" decoration update strategy but does not provide createInRange().`);
            }
            return;
        case "manual":
            if (spec.createInRange) {
                throw new Error(`[tiptap error]: Extension "${name}" uses the "manual" decoration update strategy, which is not compatible with createInRange(). createInRange() requires the "changedRanges" strategy.`);
            }
            if (spec.shouldUpdate) {
                throw new Error(`[tiptap error]: Extension "${name}" cannot combine the "manual" decoration update strategy with shouldUpdate().`);
            }
            return;
        default:
...
var DecorationManager = class {
   ...
   */ createPlugin() {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Plugin"]({
                ...
                apply: (tr, previous, oldState, newState)=>{
                    ...
                    runInDecorationApplyScope(editor, ()=>{
                        for (const { name, spec } of entries){
                            ...
                            const shouldRecompute = shouldRecomputeDecoration(spec, {
                                editor,
                                tr,
                                oldState,
                                newState
            ...
            props: {
                decorations (state) {
                    var _a, _b;
                    return (_b = (_a = DECORATION_MANAGER_PLUGIN_KEY.getState(state)) == null ? void 0 : _a.mergedDecorationSet) != null ? _b : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].empty;
                }
            }
        });
    }
   ...
   */ rebuildRanges(name, spec, previous, tr, newState, ranges) {
        ...
        for (const { from, to } of ranges){
            ...
            const { decorations: pmDecorations, widgetKeys: addedKeys } = decorationsToPMDecorations(rangeDecorations, name);
...
var ExtensionManager = class {
   ...
   */ createDecorationPlugin() {
        ...
        this.extensions.forEach((extension)=>{
            ...
            const addDecorations = getExtensionField(extension, "addDecorations", context);
            if (!addDecorations) {
                return;
            }
            entries.push({
...
function warnOnDuplicatedProseMirrorModel(schema) {
    ...
    let content;
    try {
        content = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReplaceStep"].fromJSON(schema, {
            from: 0,
            to: 0
        }).slice.content;
    } catch  {
    ...
    if (content instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"]) {
        return;
    }
...
var InlineDecoration = class extends Decoration {
    ...
    toPMDecoration(extensionName) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"].inline(this.from, this.to, this.attrs, spec);
    }
};
var NodeDecoration = class extends Decoration {
    ...
    toPMDecoration(extensionName) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"].node(this.from, this.to, this.attrs, spec);
    }
};
var WidgetDecoration = class extends Decoration {
    ...
    toPMDecoration(extensionName) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"].widget(this.pos, this.render, spec);
    }
};
